...
public final class ConnectionNonBlockingMemberPreparedStatement implements PreparedStatement {

    private final PreparedStatement ps;
    private final Connection con;

    public ConnectionNonBlockingMemberPreparedStatement(PreparedStatement ps, Connection con) {
        this.ps = ps;
        this.con = con;
    }
